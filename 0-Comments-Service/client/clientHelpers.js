...
const timeSince = (dateString) => {
  ...
  //setting to a time in the future since seed currently includes some future dates.  Will ultimately adjust to new Date()
  const now = new Date();
...
const readyComments = (commentData) => {
  let result = [];
  ...
  result.sort((a, b) => new Date(b.commentDate) - new Date(a.commentDate));
  console.log(result);
  return result;
};
